      ...
      <div className="col-span-8 grid  grid-cols-12 gap-x-5 pt-[10%] ">
        <div className="col-start-2 col-span-7 pt-[10%]   relative ">
          <p className="absolute text-justify top-[15%] left-[22%] text-sm max-w-[340px] ">
            You have selected the Order Management Result Area. Now you have to
            select a competency. "Competence is the ability, desire, and
            willingness to use a skill to consistent effect." The further
            dissection of the competencies in their attributed sub-competencies
            brings more clarity and transparency and a narrower approach in what
            is expected from an employee or prospective candidate. This
            granularity is the stage where a company gains a thorough insight in
            their individual gears that run the process.
          </p>
          <Button
            component={Link}
